...
export const generateModelImage = async (userImage: File, modelStyle: 'studio' | 'lifestyle' = 'studio'): Promise<string> => {
    ...
    const lifestylePrompt = "You are an expert lifestyle photographer AI. Transform the person in this image into a full-body lifestyle model photo taken in a REAL-WORLD ENVIRONMENT. The background MUST be one of these authentic settings: bustling city street with buildings and people, cozy coffee shop interior with tables and decor, beautiful park with trees and natural lighting, trendy home interior with furniture and decor, or vibrant neighborhood with authentic architecture. The setting should look lived-in and authentic, NOT a studio or plain backdrop. The person should appear naturally integrated into this environment with realistic lighting that matches the setting. Preserve the person's identity, unique features, and body type while placing them in a candid, natural pose that feels organic to the chosen environment. The final image must be photorealistic and capture the essence of real lifestyle photography. Return ONLY the final image.";
