...
export const generateModelImage = async (userImage: File, modelStyle: 'studio' | 'lifestyle' = 'studio'): Promise<string> => {
    ...
    const lifestylePrompt = "You are an expert fashion photographer AI. Transform the person in this image into a full-body fashion model photo with a realistic, natural-looking lifestyle background setting (e.g., urban street, park, cafe, home interior). Do NOT use a studio backdrop or plain background. The person should have a natural, relaxed expression and be interacting naturally with the environment. Preserve the person's identity, unique features, and body type, but place them in a natural, lifestyle pose that fits the setting. The final image must be photorealistic. Return ONLY the final image.";
